      ...
      <v-row>
        <v-col>
          <v-card class="mx-auto my-8" min-height="200" elevation=" 16">
            ...
            <v-card-text>
              <p>
                Au [Nom du Gym de Combat], nous vous proposons bien plus qu'un
                simple entraînement. Immergez-vous dans l'univers exceptionnel
                du combat, où la discipline, la force et la technique fusionnent
                pour créer une expérience véritablement transformante.
              </p>
            </v-card-text>
          </v-card>
          <v-card class="mx-auto my-8" min-height="200" elevation="16">
            ...
            <v-card-text>
              <p>
                Rejoignez-nous dès maintenant pour profiter de tous les
                avantages exclusifs réservés à nos membres. Démarrez votre
                voyage vers une meilleure version de vous-même !
              </p>
            </v-card-text>
            <v-card-actions
        ...
        <v-col>
          <v-card class="mx-auto my-8" max-width="600" elevation="16">
            ...
            <v-card-subtitle
              >Cours de Combat de Classe Mondiale :</v-card-subtitle
            >
            <v-card-text>
              De la boxe à la lutte, en passant par les arts martiaux mixtes
              (MMA), nos instructeurs expérimentés vous guideront à travers des
              cours dynamiques adaptés à tous les niveaux.
              <br />
              ...
              <br />
              <v-card-subtitle>Ambiance Motivante :</v-card-subtitle> Rejoignez
              une communauté passionnée et motivée.
              <br />
              L'énergie positive qui règne au sein du gym vous encouragera à
              repousser vos limites et à atteindre des sommets que vous n'auriez
              jamais imaginés.
              <br />
              <v-card-subtitle>Équipement de Pointe :</v-card-subtitle> Nos
              installations modernes sont équipées des dernières technologies et
              des meilleurs équipements pour garantir un environnement propice à
              la réussite.
              <br />
              <v-card-subtitle>Programmes de Bien-Être :</v-card-subtitle> Parce
              que la santé mentale est tout aussi
              <br />
